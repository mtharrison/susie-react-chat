...
/***/ function(module, exports, __webpack_require__) {
	...
	var _composer = __webpack_require__(160);

	var _composer2 = _interopRequireDefault(_composer);

	var _conversation = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Composer = _react2.default.createClass({
	    ...
	    sendMessage: function sendMessage() {
	        ...
	        _axios2.default.post('/new-message', {
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { disabled: this.state.usernameLocked, ref: 'username', onChange: this.update, type: 'text', value: this.state.username, placeholder: 'enter username…' })
	            ),
	            _react2.default.createElement(
	                'div',
	                { className: 'message-input' },
	                _react2.default.createElement('input', { ref: 'message', onChange: this.update, type: 'text', value: this.state.message, placeholder: 'enter message…' })
	            ),
	            _react2.default.createElement(
	                'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Conversation = _react2.default.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        evtSource.addEventListener("message", function (e) {
	            ...
	            _this.setState({
	                messages: [].concat(_toConsumableArray(_this.state.messages), [JSON.parse(e.data)])
	            });
	        });
	    },
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            (this.state.messages || []).map(function (m, i) {
	                return _react2.default.createElement(_message2.default, { key: i, username: m.username, message: m.message });
	            })
	        );
	    }
	});
